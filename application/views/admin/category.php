<?php $this->load->view('admin/global/header.php'); ?>
	<div class="content-wrapper">
        <div class="container">
         <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Category</h4>
                </div>
 			...
 			<div class="row">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">  
                      ...
                      <?php echo form_open('admin/data_controller/category');?>
                    ...
                    <div class="panel-footer text-muted">
                        <strong>Note : </strong>This is the category master
                    </div>
                </div>
                     </div>
                </div>
 ...
 <script>
  ...
  function search()
  {
  	...
  	var url = "<?php echo site_url('admin/data_controller/load_category');?>";
	...
	function remove(id){
		...
		if(confirm("Confirm Delete?")){
	  	var url = "<?php echo site_url('admin/data_controller/deleteCategory?id=');?>"+id;
	  	var xmlHttp = GetXmlHttpObject();
	  	if (xmlHttp != null) {
	  		try {
	  			xmlHttp.onreadystatechange=function() {
